...
import quickie.hackthenorth.com.quickie.JsonParserJShim;
...
public class JsonUtil {
	 ...
	 */
	public static <E> ArrayList<E> parseJsonList(JSONArray array, JsonParserJShim<E> creator) throws JSONException {
		if (array == null) {
		...
		for (int i = 0; i < size; i++) {
			if (creator.getElementType() == JsonParserJShim.ARRAY_TYPE) {
