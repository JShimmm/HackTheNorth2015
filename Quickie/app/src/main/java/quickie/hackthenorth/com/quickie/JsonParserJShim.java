 ...
 */
public abstract class JsonParserJShim<E> {
	...
	public E parse(JSONObject object) throws JSONException {
		if (getElementType() != OBJECT_TYPE) {
			throw new UnsupportedOperationException("This JsonParserJShim requires you to call parse(JSONArray): " + this.getClass().getCanonicalName());
		}
	...
	public E parse(JSONArray object) throws JSONException {
		if (getElementType() != ARRAY_TYPE) {
			throw new UnsupportedOperationException("This JsonParserJShim requires you to call parse(JSONObject): " + this.getClass().getCanonicalName());
		}
	 ...
	 * @param <E>
	 */
	public static abstract class DualCreator<E> extends JsonParserJShim<E> implements Parcelable.Creator<E> {
